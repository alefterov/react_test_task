    ...
    render() {
        return(
            <div className={styles.file_container}>
                <input id="file_input" className={styles.file_input} type="file" name="file_input" multiple
                ...
                <p className={styles.count_files}>{this.props.countOfFiles} files attached</p>
            </div>
        );
    }
